...
var useIsomorphicLayoutEffect$1 = typeof document !== "undefined" ? import_react.default.useLayoutEffect : import_react.default.useEffect;
function systemToComponent(systemSpec, map2, Root) {
  ...
  const Component = import_react.default.forwardRef((propsWithChildren, ref) => {
    ...
    return (0, import_jsx_runtime.jsx)(Context.Provider, { value: system2, children: Root ? (0, import_jsx_runtime.jsx)(RootComponent, { ...omit([...requiredPropNames, ...optionalPropNames, ...eventNames], props), children }) : children });
  });
...
var DefaultScrollSeekPlaceholder$1 = ({ height }) => (0, import_jsx_runtime.jsx)("div", { style: { height } });
var GROUP_STYLE = { position: positionStickyCssValue(), zIndex: 1, overflowAnchor: "none" };
var ITEM_STYLE$1 = { overflowAnchor: "none" };
var HORIZONTAL_ITEM_STYLE = { ...ITEM_STYLE$1, display: "inline-block", height: "100%" };
var Items$1 = import_react.default.memo(function VirtuosoItems({ showTopList = false }) {
  ...
  if (!showTopList && listState.totalCount === 0 && EmptyPlaceholder) {
    return (0, import_jsx_runtime.jsx)(EmptyPlaceholder, { ...contextPropIfNotDomElement(EmptyPlaceholder, context) });
  }
...
var Header$1 = import_react.default.memo(function VirtuosoHeader() {
  ...
  const ref = useSize(
    import_react.default.useMemo(() => (el) => headerHeight(correctItemSize(el, "height")), [headerHeight]),
    true,
    useEmitterValue$2("skipAnimationFrameInResizeObserver")
  );
  const context = useEmitterValue$2("context");
  return Header2 ? (0, import_jsx_runtime.jsx)(HeaderFooterTag, { ref, children: (0, import_jsx_runtime.jsx)(Header2, { ...contextPropIfNotDomElement(Header2, context) }) }) : null;
});
var Footer$1 = import_react.default.memo(function VirtuosoFooter() {
  ...
  const HeaderFooterTag = useEmitterValue$2("HeaderFooterTag");
  const ref = useSize(
    import_react.default.useMemo(() => (el) => footerHeight(correctItemSize(el, "height")), [footerHeight]),
    true,
    useEmitterValue$2("skipAnimationFrameInResizeObserver")
  );
  const context = useEmitterValue$2("context");
  return Footer2 ? (0, import_jsx_runtime.jsx)(HeaderFooterTag, { ref, children: (0, import_jsx_runtime.jsx)(Footer2, { ...contextPropIfNotDomElement(Footer2, context) }) }) : null;
});
...
var Viewport$2 = ({ children }) => {
  ...
  const alignToBottom = useEmitterValue$2("alignToBottom");
  const horizontalDirection = useEmitterValue$2("horizontalDirection");
  const viewportSizeCallbackMemo = import_react.default.useMemo(
  ...
  return (0, import_jsx_runtime.jsx)("div", { style: viewportStyle(alignToBottom), ref: viewportRef, "data-viewport-type": "element", children });
};
var WindowViewport$2 = ({ children }) => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: viewportRef, style: viewportStyle(alignToBottom), "data-viewport-type": "window", children });
};
var TopItemListContainer = ({ children }) => {
  ...
  const context = useEmitterValue$2("context");
  return (0, import_jsx_runtime.jsx)(TopItemList, { style, ...contextPropIfNotDomElement(TopItemList, context), children });
};
var ListRoot = import_react.default.memo(function VirtuosoRoot(props) {
  ...
  return (0, import_jsx_runtime.jsxs)(TheScroller, { ...props, children: [
    showTopList && (0, import_jsx_runtime.jsx)(TopItemListContainer, { children: (0, import_jsx_runtime.jsx)(Items$1, { showTopList: true }) }),
    (0, import_jsx_runtime.jsxs)(TheViewport, { children: [
      (0, import_jsx_runtime.jsx)(Header$1, {}),
      (0, import_jsx_runtime.jsx)(Items$1, {}),
  ...
  return (0, import_jsx_runtime.jsx)(
    ListComponent,
    {
      ...
      children: gridState.items.map((item) => {
        ...
        return isSeeking ? (0, import_jsx_runtime.jsx)(
          ScrollSeekPlaceholder,
          {
            ...contextPropIfNotDomElement(ScrollSeekPlaceholder, context),
            index: item.index,
...
var Viewport$1 = ({ children }) => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { style: viewportStyle(false), ref: viewportRef, children });
};
var WindowViewport$1 = ({ children }) => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: viewportRef, style: viewportStyle(false), children });
};
var GridRoot = import_react.default.memo(function GridRoot2({ ...props }) {
  ...
  return (0, import_jsx_runtime.jsx)(TheScroller, { ...props, children: (0, import_jsx_runtime.jsxs)(TheViewport, { children: [
    (0, import_jsx_runtime.jsx)(Header, {}),
    (0, import_jsx_runtime.jsx)(GridItems, {}),
...
var tableComponentPropsSystem = system(() => {
  const itemContent = statefulStream((index) => (0, import_jsx_runtime.jsxs)("td", { children: [
    "Item $",
    index
  ] }));
  const context = statefulStream(null);
...
var DefaultScrollSeekPlaceholder = ({ height }) => (0, import_jsx_runtime.jsx)("tr", { children: (0, import_jsx_runtime.jsx)("td", { style: { height } }) });
var DefaultFillerRow = ({ height }) => (0, import_jsx_runtime.jsx)("tr", { children: (0, import_jsx_runtime.jsx)("td", { style: { height, padding: 0, border: 0 } }) });
var ITEM_STYLE = { overflowAnchor: "none" };
var Items = import_react.default.memo(function VirtuosoItems2({ showTopList = false }) {
  ...
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: items });
});
var TableBody = import_react.default.memo(function TableVirtuosoBody() {
  const listState = useEmitterValue("listState");
  ...
  const paddingTopEl = paddingTop > 0 ? (0, import_jsx_runtime.jsx)(FillerRow, { height: paddingTop, context }, "padding-top") : null;
  const paddingBottomEl = paddingBottom > 0 ? (0, import_jsx_runtime.jsx)(FillerRow, { height: paddingBottom, context }, "padding-bottom") : null;
  return (0, import_jsx_runtime.jsxs)(TableBodyComponent, { ref: callbackRef, "data-testid": "virtuoso-item-list", ...contextPropIfNotDomElement(TableBodyComponent, context), children: [
    paddingTopEl,
    showTopList && (0, import_jsx_runtime.jsx)(Items, { showTopList: true }),
    (0, import_jsx_runtime.jsx)(Items, {}),
    paddingBottomEl
  ] });
});
var Viewport = ({ children }) => {
  ...
  const viewportRef = useSize(
    import_react.default.useMemo(() => compose(viewportHeight, (el) => correctItemSize(el, "height")), [viewportHeight]),
    true,
    useEmitterValue("skipAnimationFrameInResizeObserver")
  );
  import_react.default.useEffect(() => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { style: viewportStyle(false), ref: viewportRef, "data-viewport-type": "element", children });
};
var WindowViewport = ({ children }) => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: viewportRef, style: viewportStyle(false), "data-viewport-type": "window", children });
};
var TableRoot = import_react.default.memo(function TableVirtuosoRoot(props) {
  ...
  const theadRef = useSize(
    import_react.default.useMemo(() => compose(fixedHeaderHeight, (el) => correctItemSize(el, "height")), [fixedHeaderHeight]),
    true,
    useEmitterValue("skipAnimationFrameInResizeObserver")
  );
  const tfootRef = useSize(
    import_react.default.useMemo(() => compose(fixedFooterHeight, (el) => correctItemSize(el, "height")), [fixedFooterHeight]),
    true,
    useEmitterValue("skipAnimationFrameInResizeObserver")
  );
  ...
  const theHead = fixedHeaderContent ? (0, import_jsx_runtime.jsx)(
    TheTHead,
    {
  ...
  const theFoot = fixedFooterContent ? (0, import_jsx_runtime.jsx)(
    TheTFoot,
    {
  ...
  return (0, import_jsx_runtime.jsx)(TheScroller, { ...props, children: (0, import_jsx_runtime.jsx)(TheViewport, { children: (0, import_jsx_runtime.jsxs)(TheTable, { style: { borderSpacing: 0, overflowAnchor: "none" }, ...contextPropIfNotDomElement(TheTable, context), children: [
    theHead,
    (0, import_jsx_runtime.jsx)(TableBody, {}, "TableBody"),
    theFoot
  ] }) }) });
});
var {
