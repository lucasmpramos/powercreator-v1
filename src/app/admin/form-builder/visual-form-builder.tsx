...
export default function VisualFormBuilder() {
  ...
  const onDrop = useCallback((event: React.DragEvent) => {
    ...
    // Create a container node if it's not a container type
    if (!CONTAINER_TYPES.includes(fieldData.type as ContainerType)) {
      ...
      setNodes(nds => nds.concat(containerNode));
      setSelectedNode(containerNode);
    } else {
      // If it's a container type, create it normally
  ...
  const renderFieldCategories = useCallback(() => (
